    ...
    <div>
      {restaurantList.map((location: any, index: any) => {
        if (index % 2 == 0) {
          return (
            <div
              className="col-lg-6 s-piza addressGrid b-bottom col-sm-12 col-xs-12"
              key={index}
            >
              <div className="col-lg-12">
                <div className="col-lg-8">
                  <h5 className="size_22 color_black weight_300">
                    <i className="fa fa-cutlery" /> {location?.restaurantname}
                  </h5>
                  {location.website && (
                ...
                <div className="col-lg-4">
                  <a
                    target="_blank"
                    href={`/${location.restaurantURL}/`}
                    rel="noopener noreferrer"
                  >
                    {location.logo ? (
                      <img
                        src={location.logo}
                        alt={location.restaurantname}
                        width={180}
                        height={100}
                      />
                    ) : (
                  ...
                  >
                    <button
                      type="button"
                      className="btn btn-warning btn-lg margin_top_20"
                    >
                      {" "}
                      Order Now
                    </button>
              ...
              <div className="col-lg-12">
                <h5 className="size_22 color_black weight_300 margin_bottom_20">
                  {location?.locationDetails &&
                    location?.locationDetails?.length > 0 && (
                      <>
                        <span
                          className="size_20 color_grey margin_bottom_10"
                ...
                {location &&
                  location?.locationDetails.map((data: any, newindex: any) => (
                    <>
                      ...
                      <div
                        className={
                          location?.locationDetails.length > 1
                            ? "col-lg-6"
                            : "col-lg-12 "
                        }
                        key={newindex}
                      >
                        ...
                        >
                          <img
                            src="/defaulttheme/images/pin.png"
          ...
          return (
            <div
              className="col-lg-6 s-piza addressGrid b-right b-bottom col-sm-12 col-xs-12"
              key={index}
            >
              <div className="col-lg-12">
                <div className="col-lg-8">
                    ...
                    >
                      ...
                      <div className="col-lg-10 padding_left_0">
                        ...
                        {data.locationURL !== undefined ? (
                          <a
                            href={
                              location?.restaurantURL + "/" + data?.locationURL
                            }
                            target="_blank"
                            rel="noopener noreferrer"
                          >
