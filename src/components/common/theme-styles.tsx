    ...
    <>
      {themeType === "default" && (
        <>
          ...
          <link href="/defaulttheme/css/jquery.bxslider.css" rel="stylesheet" type="text/css" />
          <link
      ...
      {themeType === "dominos" && (
        <>
          <link href="/dominos/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
          <link rel="stylesheet" type="text/css" href="/dominos/css/animate.min.css" />
          <link
            rel="stylesheet"
            type="text/css"
            href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
          />
          <link rel="stylesheet" type="text/css" href="/dominos/css/owl.carousel.min.css" />
          <link rel="stylesheet" type="text/css" href="/dominos/css/owl.theme.default.min.css" />
          <link href="/dominos/css/custom.css" rel="stylesheet" type="text/css" />
          <link href="/dominos/css/style.css" rel="stylesheet" type="text/css" />
          <link href="/dominos/css/responsive.css" rel="stylesheet" type="text/css" />
      ...
      {themeType === "tableorder" && (
        <>
          <link rel="stylesheet" href="/to/css/bootstrap.min.css" type="text/css" />
          <link rel="stylesheet" href="/to/css/font-awesome.css" type="text/css" />
          ...
          <link rel="stylesheet" href="/to/css/responsive.css" type="text/css" />
        </>
      )}
    </>
  )
