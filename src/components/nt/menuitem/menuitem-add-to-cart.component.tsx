...
import { updateCartItemCount } from "../../../../redux/cart/cart.slice";
  ...
  const addtocartclick = (item: any) => {
    ...
    MenuItemServices.getMenuItemList({
      ...
      if (response) {
        ...
        //   menuItemDetail.size?.filter((x: any) => x.sizeselected == true);
        // let selectedtopping =
        //   selectedsize &&
        ...
        //     (x: any) => x.subparameterId == selectedsize[0].subparameterId
        //   );
        // let selectedoption =
        ...
        //               //     payload: response,
        //               //   });
        //               dispatch(getCategoryItemList(response) as any);
        //               // handlUpdateQty()
        //             }
        //           }
        //         });
        ...
        //         //             (item: any) => item?.DependantMenuItemId
        //         //           );
