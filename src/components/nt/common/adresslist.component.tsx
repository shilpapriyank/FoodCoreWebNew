...
const AddressList: React.FC<AddressListProps> = ({ handleChangeLocation, selectedLocationId }) => {
    ...
    const addressList: AddressItem[] = (restaurant?.restaurantslocationlistwithtime as any)?.addressList ?? [];
                ...
                .map((address) => {
                    const isChecked =
                        selectedLocationId > 0
                            ...
                            : restaurantinfo?.defaultLocation?.locationId === address.locationId;
