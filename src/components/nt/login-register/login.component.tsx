                        ...
                        <form>
                                    ...
                                    <div className="col-lg-12 col-md-12 col-12">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-9 col-md-9 col-8 offset-0 offset-lg-0 offset-md-0">
                                                <label>Phone</label>
                                                <input type="text" placeholder="Enter phone number" name="phone" className="form-control" value={userName} onChange={(e) => handleChangeUserName(e)} onPaste={handlePaste} autoComplete="off" required />
                                            ...
                                            <div className="col-lg-12 col-md-12 col-12 ">
                                                ...
                                                <div className="pass-input mb-2 position-relative">
                                                    ...
                                                    />
                                                    <i
                                                        className={`fa ${showPassword ? "fa-eye" : "fa-eye-slash"} fa-lg eye-icon`}
                                        ...
                                        {!b2b && <div className="text-start mt-1">
                                            <a className="address-nfound" onClick={handleClickForgotPass} > FORGOT PASSWORD? </a>
                                        </div>}
                                    </div>
                                </div>
                            </div>
                            <div className="modal-footer">
                                <div className="row w-100 ms-auto me-auto">
                                    {!b2b && <div className="col-lg-6 text-center col-md-6 col-12">
                                        <ButtonLoader isLoader={false} classname={`btn-default black w-100`} btnType={"button"} handleClick={() => handleOpenLoginModal(false)} isDisable={isDisable || submitting} textName="Cancel" ></ButtonLoader>
                                    </div>}
                                    <div className={`col-lg-${!b2b ? "6" : "12"} text-center col-md-${!b2b ? "6" : "12"} col-12`}>
                                        <ButtonLoader
                                            isLoader={isDisable}
                                            classname={`${(isDisable || submitting) ? `btn-default w-100 opacity-50 pe-none` : `btn-default w-100`}`}
                                            btnType="submit"
