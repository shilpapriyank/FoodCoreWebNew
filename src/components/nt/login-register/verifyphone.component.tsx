...
// // import CommonModal from '../common/common-modal.component'
// // import { useReduxData } from '../../customhooks/useredux-data-hook';
// // import useFireBaseAuth from '../../customhooks/usefirebaseauth-hook';
// // import { convertSecondToMinute } from '../../dominos/helpers/utility';
// // import { RegisterServices } from '../../../redux/register/register.services';
// import { allRegex, countryData, formatePhoneNumber, getCountryList, onLoadSetDefaultFlag, unFormatePhoneNumber } from '../../common/utility';
...
// const VerifyPhoneComponent: React.FC<VerifyPhoneComponentProps> = ({ isOpenModal, handleToggle }) => {
...
//     let otpTime = convertSecondToMinute((process.env.NEXT_PUBLIC_OTP_DURATION) as any)
...
//     let defaultflag = document.querySelector(".verify-country")?.previousElementSibling?.firstElementChild?.firstElementChild
//     let countryList = document.querySelector(".verify-country")?.previousElementSibling?.children[1]
//     useEffect(() => {
...
//             handleSendOtpHook(dialCode.toString(), phonenumber).then((res: any) => {
...
//     return (
//         <>
//             {!isotpVerification && <CommonModal title="Verify Phone"
//                 btn1Name=''
//                 isbtn2={false}
//                 isOpenModal={isOpenModal}
//                 isDisplayCloseIcon={false}
//             >
//                 <p> Your Phone number is not verified <a className='cursor'> {userinfo?.phone} </a>
//                     <br /> Please update your phone number.</p>
...
//                                 <input type="text" placeholder="Enter phone number" name="phone" required className="form-control" value={values.phone}
...
//                                 {buttonDisable ?
//                                     <button className=" not-uppercase btn-default btn-orange w-46 greyColor"  > Send OTP </button>
//                                     :
//                                     <button className=" not-uppercase btn-default btn-orange w-46" type='button' onClick={handleSendOTP}> Send OTP </button>
//                                 }
//                             </div>
//                         </div>
//                     </div>
...
//                         key='openVerifyPhone' handleValidateOTPHook={handleValidateOTPHook} handleSendOtpHook={handleSendOtpHook} isOtpSecond={false} mysecond={second} otpMinute={minutes}
//                         dialCode={dialCode} handlclickErrorbtn={handlclickErrorbtn} userModel={values} OTPDetail={OTPDetail}
//                         confirmationResult={window.confirmationResult} isOpenModal={isotpVerification} handleToggle={handleToggle} isotpVerification={isotpVerification} isUserRegister={false}
