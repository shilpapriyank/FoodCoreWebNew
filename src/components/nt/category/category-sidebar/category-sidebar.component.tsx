        ...
        <>
                ...
                <div className="sidebar">
                    ...
                    <div className="card totalbox">
                        ...
                        {cart?.cartitemcount > 0 ? <a className="btn-default w-100" onClick={handleClick}> Go To Cart<i className="fa fa-angle-right" />{" "} </a>
                            : <a className="btn-default w-100 greyColor"> Go To Cart 123 <i className="fa fa-angle-right" />{" "} </a>}
                    </div>
                </div>
            </div>
            {(restaurantinfo?.displayLocationPopUpChange && isOpenChangeLocation) &&
                <CommonModal title="Confirm Location"
                    //  isButton={true}
                    btn1Name='Confirm' handleToggle={handleToggle} isOpenModal={isOpenChangeLocation} isbtn2={true} btn2Name="No change" handleClickBtn2={handleClickBtn2} handleClickBtn1={handleClickOk}
                // isChild={true}
                >
