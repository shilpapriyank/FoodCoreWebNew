                ...
                <div className="row">
                    <div className="col-12 position-relative">
                        <p className="form-check-label text-dark fw-semibold fs-6 time-pill" >
                            {label}
                            <input onChange={() => { }} disabled={isDisable} checked={selectedTime === `${time.StartSlotNew} - ${time.EndSlotNew}`} className="time-slot-radio form-check-input position-absolute top-0 right-20 " type="radio" name={`A`} id="flexRadioDefault1 " />
                        </p>
                    </div>
                </div>
            </div>
