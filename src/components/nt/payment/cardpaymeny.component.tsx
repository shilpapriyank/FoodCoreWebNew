...
//   const [loadThreeDModal, setLoadThreeDModal] = useState(false);
//   const [returnUrl, setReturnUrl] = useState("");
//   const [is3dFail, setis3dFail] = useState(false);
...
// //           closeButton?.click();
// //           const getElement = document.getElementById("threed-iframe");
// //           getElement?.remove();
// //           setis3dFail(true);
// //           setErrorMessage(data?.paymentIntent?.last_payment_error?.message);
...
//   const handleLoadModal = (value:any) => {
//     setLoadModal(value);
//   };
//   return (
//     <>
...
// const RawHTML = ({ children, className = "" }: any) => (
//   <div
//     className={className}
