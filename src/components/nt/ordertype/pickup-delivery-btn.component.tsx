...
const PickupDeliveryButton = ({
  ...
  const isEnableDelivery = checkDisableWindow(
    ...
    (futureDay as FutureOrderingDayDateTypes)?.futureDay
  );
      ...
      {(isTakeOutAsap || isTakeOutPickupTime) && (
        <>
          {defaultLocation.istakeaway === true && isEnablePickup ? (
            ...
            <>
              <a className="btn-default opacity-50 pe-none" id="takeout-btn">
                <i className="fa fa-shopping-bag" /> Pickup
              </a>
            </>
          )}
        </>
        ...
        <>
          {defaultLocation.isdelivery === true && isEnableDelivery ? (
            ...
            <a className="btn-default opacity-50 pe-none" id="delivery-btn">
              <i className="fa fa-car" /> Delivery
            </a>
          )}
        </>
      )}
