...
//                 dispatch((refreshCategoryList as any)(restaurantinfo, customerId));
//                 dispatch((getSelectedRestaurantTime as any)(restaurantinfo.restaurantId, lid));
